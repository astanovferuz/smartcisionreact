...
function ExpandedDecision({selectedDecision, handleDeleteDec}) {
    return(
        <div className="exDecisionBack p-3 borderYellow">
            ...
            <Button size="sm" className="fontBold backWhite text-black primButton">Evaluate Decision</Button>
            <Button size="sm ml-2" className="fontBold backWhite text-black warnButton">Edit Decision</Button>
